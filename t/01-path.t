...
use_ok( 'BBQ' ) || print "Bail out!\n";
    ...
    is($out2, '<strong>1<strong>2<strong>3</strong>4</strong>5', 'pre path test');
    is_deeply( $bbq->{path}, ['b'], 'unbalanced path test');
    ...
    is($out3, '<strong>1[c]2[d]', 'pre path test');
    is_deeply( $bbq->{path}, ['b'], 'unbalanced path test with wrong tags');
